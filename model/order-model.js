...
module.exports = {
	insert: function(order, callback){
		var sql = "INSERT INTO orderinfo VALUES (null, '" + order.customer_id + "', '" + order.customer_address + "', '" + order.order_date + "', '" + order.shipping_date + "', '" + order.order_amount + "', '" + order.delivery_status + "', '" + order.productName + "', '" + order.quantity + "')";
